...
rnn_cell = tf.contrib.rnn.MultiRNNCell(cells=[make_cell(hidden_layer_size) for _ in range(num_lstm_layers)], state_is_tuple=True)
...
final_output = tf.matmul(states[num_lstm_layers - 1][1], Wl) + bl 
